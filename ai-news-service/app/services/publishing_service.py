...
class PublishingService:
    ...
    async def publish(self, top_n: int = 20) -> int:
        ...
        # reference_urls are populated upstream by SearchEnrichmentService before
        # this method is called. Publishing never calls Google Search directly —
        # that ensures each article is searched at most once across all cycles.
        rows = []
        for article in top_articles:
            ...
            rows.append({
                ...
                "reference_urls": article.reference_urls or [],
